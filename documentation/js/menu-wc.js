...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">bcs-fan-site-fe documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/EpisodeComponent.html" data-type="entity-link" >EpisodeComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/EpisodesComponent.html" data-type="entity-link" >EpisodesComponent</a>
                            </li>
                            <li class="link">
